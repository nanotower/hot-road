...
const TopicEdit = ({
  ...
  const handleChangeName = (event) => setTopicTitle(event.target.value);
  ...
  return (
    <Grid.Row key={topic.topicId}>
      ...
      <Grid.Column width={1} floated="right">
        <Button icon color="blue" content="focus" onClick={handleClick}>
          <Icon name="pencil" />
        </Button>
      </Grid.Column>
      <Grid.Column width={1} floated="right">
        <Button icon color="blue" onClick={handleSubmitUpdate}>
          <Icon name="checkmark" />
        </Button>
      </Grid.Column>
      <Grid.Column width={1} floated="right">
